...
FUNCTION(GENERATE_CPPCHECK)
    ...
    IF(CPPCHECK_FOUND)
        ...
        set(options INLINE_SUPPRESSION)
        set(oneValueArgs SOURCES SUPPRESSION_FILE ENABLE_IDS TARGET_NAME INCLUDES)
        set(multiValueArgs "")
...
"
EXECUTE_PROCESS(COMMAND \"${CPPCHECK_EXECUTABLE}\" ${INCLUDE_ARGUMENTS} ${SUPPRESSION_ARGUMENT} ${SUPPRESSION_FILE} ${INLINE_ARG} ${IDS_ARGUMENT}  --inconclusive --force --xml \"--file-list=${CPPCHECK_CHECKFILE}\"

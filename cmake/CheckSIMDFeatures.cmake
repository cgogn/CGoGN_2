...
macro(CGOGN_CHECK_FOR_SSE)
	...
	if(NOT MSVC)
		...
		if (HAVE_AVX2_EXTENSIONS)
			...
			set(CGOGN_SSE_FLAGS "${CGOGN_SSE_FLAGS} -mavx2")
		elseif (HAVE_AVX1_EXTENSIONS)
			message(STATUS "avx support detected.")
			set(CGOGN_SSE_FLAGS "${CGOGN_SSE_FLAGS} -mavx")
		elseif(HAVE_SSE4_2_EXTENSIONS)
			message(STATUS "ss4.2 support detected.")
			set(CGOGN_SSE_FLAGS "${CGOGN_SSE_FLAGS} -msse4.2")
		elseif(HAVE_SSE4_1_EXTENSIONS)
			message(STATUS "ss4.1 support detected.")
			set(CGOGN_SSE_FLAGS "${CGOGN_SSE_FLAGS} -msse4.1")
		elseif(HAVE_SSSE3_EXTENSIONS)
			message(STATUS "sse3 support detected.")
			set(CGOGN_SSE_FLAGS "${CGOGN_SSE_FLAGS} -mssse3")
		elseif(HAVE_SSE2_EXTENSIONS)
			message(STATUS "sse2 support detected.")
			set(CGOGN_SSE_FLAGS "${CGOGN_SSE_FLAGS} -msse2")
		elseif(HAVE_SSE_EXTENSIONS)
			message(STATUS "sse support detected.")
			set(CGOGN_SSE_FLAGS "${CGOGN_SSE_FLAGS} -msse")
		# else()

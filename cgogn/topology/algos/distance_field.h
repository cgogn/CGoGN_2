...
extern template class CGOGN_TOPOLOGY_EXPORT DistanceField<float32, CMap2>;
extern template class CGOGN_TOPOLOGY_EXPORT DistanceField<float64, CMap2>;
extern template class CGOGN_TOPOLOGY_EXPORT DistanceField<float32, CMap3>;
extern template class CGOGN_TOPOLOGY_EXPORT DistanceField<float64, CMap3>;

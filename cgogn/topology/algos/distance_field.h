...
public:
	...
	{
		edge_weight_ = map.template attribute<Scalar, Edge::ORBIT>("__edge_weight__");
...
public:
									 ...
									 VertexAttribute<Scalar>& scalar_field)
	{
		VertexAttribute<Scalar> distance_to_feature =
				map_.template attribute<Scalar, Vertex::ORBIT>("__distance_to_feature__");
	...
	void morse_distance_to_boundary(VertexAttribute<Scalar>& morse_function)
	{
		VertexAttribute<Scalar> distance_to_boundary =
				map_.template attribute<Scalar, Vertex::ORBIT>("__distance_to_boundary__");
									...
									VertexAttribute<Scalar>& morse_function)
	{
		VertexAttribute<Scalar> distance_to_features =
				map_.template attribute<Scalar, Vertex::ORBIT>("__distance_to_features__");

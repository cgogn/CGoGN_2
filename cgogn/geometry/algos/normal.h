...
{
	compute_normal<VEC3>(map, CellFilters(true), position, face_normal);
}
...
{
	compute_normal<VEC3>(map, CellFilters(true), position, vertex_normal);
}
...
{
	compute_normal<VEC3>(map, CellFilters(true), position, face_normal, vertex_normal);
}

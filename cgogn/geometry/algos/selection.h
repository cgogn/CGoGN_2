...
extern template CGOGN_GEOMETRY_EXPORT class Collector_OneRing<Eigen::Vector3f, CMap2>;
extern template CGOGN_GEOMETRY_EXPORT class Collector_OneRing<Eigen::Vector3d, CMap2>;
extern template CGOGN_GEOMETRY_EXPORT class Collector_OneRing<Eigen::Vector3f, CMap3>;
extern template CGOGN_GEOMETRY_EXPORT class Collector_OneRing<Eigen::Vector3d, CMap3>;
extern template CGOGN_GEOMETRY_EXPORT class Collector_WithinSphere<Eigen::Vector3f, CMap2>;
extern template CGOGN_GEOMETRY_EXPORT class Collector_WithinSphere<Eigen::Vector3d, CMap2>;
extern template CGOGN_GEOMETRY_EXPORT class Collector_WithinSphere<Eigen::Vector3f, CMap3>;
extern template CGOGN_GEOMETRY_EXPORT class Collector_WithinSphere<Eigen::Vector3d, CMap3>;

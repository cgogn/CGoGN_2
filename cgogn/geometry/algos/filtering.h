...
{
	filter_average<T>(map, CellFilters(true), attribute_in, attribute_out);
}
...
{
	filter_bilateral<VEC3>(map, CellFilters(true), position_in, position_out, normal);
}
...
{
	filter_taubin<VEC3>(map, CellFilters(true), position, position_tmp);
}

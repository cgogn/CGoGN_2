...
TYPED_TEST(Algos_TEST, TriangleArea)
{
	...
	const Scalar area = cgogn::geometry::triangle_area<TypeParam>(this->map2_, CMap2::Face(t), vertex_position);
	const Scalar cf_area = cgogn::geometry::convex_face_area<TypeParam>(this->map2_, CMap2::Face(t), vertex_position);
...
TYPED_TEST(Algos_TEST, QuadArea)
{
	...
	const Scalar area = cgogn::geometry::convex_face_area<TypeParam>(this->map2_, CMap2::Face(q), vertex_position);
...
TYPED_TEST(Algos_TEST, TriangleCentroid)
{
	...
	Dart t;
	this->map2_.foreach_dart_until([&t] (Dart d) { t = d; return false; });
	const TypeParam centroid = cgogn::geometry::centroid<TypeParam>(this->map2_, CMap2::Face(t), vertex_position);
...
TYPED_TEST(Algos_TEST, QuadCentroid)
{
	...
	Dart q;
	this->map2_.foreach_dart_until([&q] (Dart d) { q = d; return false; });
	const TypeParam centroid = cgogn::geometry::centroid<TypeParam>(this->map2_, CMap2::Face(q), vertex_position);
...
TYPED_TEST(Algos_TEST, TriangleNormal)
{
	...
	Dart t;
	this->map2_.foreach_dart_until([&t] (Dart d) { t = d; return false; });
	const TypeParam& n1 = cgogn::geometry::triangle_normal<TypeParam>(this->map2_, CMap2::Face(t), vertex_position);
	const TypeParam& n2 = cgogn::geometry::face_normal<TypeParam>(this->map2_, CMap2::Face(t), vertex_position);
...
TYPED_TEST(Algos_TEST, QuadNormal)
{
	...
	Dart q;
	this->map2_.foreach_dart_until([&q] (Dart d) { q = d; return false; });
	const TypeParam& n1 = cgogn::geometry::face_normal<TypeParam>(this->map2_, CMap2::Face(q), vertex_position);
	const TypeParam& cross = n1.cross(TypeParam(Scalar(0), Scalar(0), Scalar(1)));
	EXPECT_TRUE(cgogn::almost_equal_relative(cross[0], Scalar(0)));
	EXPECT_TRUE(cgogn::almost_equal_relative(cross[1], Scalar(0)));
	EXPECT_TRUE(cgogn::almost_equal_relative(cross[2], Scalar(0)));

...
{
	{
		...
		EXPECT_TRUE(bb3.contains(StdArray({ 0.2, 0.2, 0.2 }), StdArray({ 0.5, 0.5, 0.5 })));
		EXPECT_FALSE(bb3.contains(StdArray({ -0.5, -0.5, -0.5 }), StdArray({ 0.5, 0.5, 0.5 })));
		EXPECT_FALSE(bb3.contains(StdArray({ 0.5, 0.5, 0.5 }), StdArray({ 1.5, 0.5, 1.5 })));
	}
	{
		BoundingBox_Eigen bb;
		bb.add_point(EigenVec3d(0.5,0.4,0.3));
		...
		EXPECT_TRUE(bb3.contains(EigenVec3d(0.2, 0.2, 0.2), EigenVec3d(0.5, 0.5, 0.5)));
		EXPECT_FALSE(bb3.contains(EigenVec3d(-0.5, -0.5, -0.5), EigenVec3d(0.5, 0.5, 0.5)));
		EXPECT_FALSE(bb3.contains(EigenVec3d(0.5, 0.5, 0.5), EigenVec3d(1.5, 0.5, 1.5)));
	}
}

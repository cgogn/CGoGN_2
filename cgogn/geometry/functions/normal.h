...
inline typename vector_traits<VEC3a>::Type normal(const Eigen::MatrixBase<VEC3a>& p1, const Eigen::MatrixBase<VEC3b>& p2, const Eigen::MatrixBase<VEC3c>& p3)
{
	...
	static_assert(is_dim_of<VEC3a>(3), "The size of the vector must be equal to 3.");
...
{
	static_assert(is_vector<VEC3>(), "parameters must be vectors");
	static_assert(is_dim_of<VEC3>(3), "The size of the vector must be equal to 3.");

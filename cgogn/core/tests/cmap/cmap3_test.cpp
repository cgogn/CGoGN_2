...
TEST_F(CMap3Test, merge)
{
	...
	map3.get_attribute<int32, Vertex::ORBIT>("vertices");
	map3.get_attribute<int32, Face::ORBIT>("faces");
...
TEST_F(CMap3Test, merge_map2)
{
	...
	// Embed the map
	map2.get_attribute<int32, CMap2::Vertex::ORBIT>("vertices");
	map2.get_attribute<int32, CMap2::Face::ORBIT>("faces");

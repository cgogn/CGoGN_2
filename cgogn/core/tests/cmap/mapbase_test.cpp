...
public:
	...
	using Attribute = typename Map::template Attribute<T,ORBIT>;
...
TYPED_TEST(MapBaseTest, add_attribute)
{
	...
	Attribute <int32, Vertex::ORBIT> vatt2;
	this->cmap_.add_attribute(vatt2, "cool_attribute2");
	EXPECT_TRUE(vatt2.is_valid());

...
int main(int , char** )
{
...

	{
		...
		cgogn::io::export_surface(map, cgogn::io::create_export_options().filename("grid.off").position_attribute(vertorb, "grid").binary(false));
		cgogn::io::export_surface(map, cgogn::io::create_export_options().filename("twisted_strip.off").position_attribute(vertorb, "twisted_strip").binary(false));
		cgogn::io::export_surface(map, cgogn::io::create_export_options().filename("helicoid.off").position_attribute(vertorb, "helicoid").binary(false));
	}

	{
		...
		cgogn::io::export_surface(map, cgogn::io::create_export_options().filename("cylinder.off").position_attribute(vertorb, "cylinder").binary(false));
		cgogn::io::export_surface(map, cgogn::io::create_export_options().filename("sphere.off").position_attribute(vertorb, "sphere").binary(false));
		cgogn::io::export_surface(map, cgogn::io::create_export_options().filename("cone.off").position_attribute(vertorb, "cone").binary(false));
	}

	{
		...
		cgogn::io::export_surface(map, cgogn::io::create_export_options().filename("tore.off").position_attribute(vertorb, "tore").binary(false));
	}

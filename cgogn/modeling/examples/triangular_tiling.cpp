...
int main(int , char** )
{
    ...
    {
        Map2 map;
        VertexAttribute<Vec3> vertex_grid = map.get_attribute<Vec3, Map2::Vertex::ORBIT>("grid");
        VertexAttribute<Vec3> vertex_twisted_strip = map.get_attribute<Vec3, Map2::Vertex::ORBIT>("twisted_strip");
        VertexAttribute<Vec3> vertex_helicoid = map.get_attribute<Vec3, Map2::Vertex::ORBIT>("helicoid");

        //		map.get_attribute<int32, Map2::CDart::ORBIT>("darts");
        map.get_attribute<int32, Map2::Edge::ORBIT>("edges");
        map.get_attribute<int32, Map2::Face::ORBIT>("faces");
        map.get_attribute<int32, Map2::Volume::ORBIT>("volumes");
    ...
    {
        Map2 map;
        VertexAttribute<Vec3> vertex_cylinder = map.get_attribute<Vec3, Map2::Vertex::ORBIT>("cylinder");
        VertexAttribute<Vec3> vertex_sphere = map.get_attribute<Vec3, Map2::Vertex::ORBIT>("sphere");
        VertexAttribute<Vec3> vertex_cone = map.get_attribute<Vec3, Map2::Vertex::ORBIT>("cone");
    ...
    {
        Map2 map;
        VertexAttribute<Vec3> vertex_tore = map.get_attribute<Vec3, Map2::Vertex::ORBIT>("tore");
    ...
    /*	{
                ...
                VertexAttribute<Vec3> vertex_tore = map.get_attribute<Vec3, Map2::Vertex::ORBIT>("cube");

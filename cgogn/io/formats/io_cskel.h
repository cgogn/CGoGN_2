...
#ifndef CGOGN_IO_CSKEL_IO_H_
#define CGOGN_IO_CSKEL_IO_H_
...
class CskelGraphImport : public GraphFileImport<VEC3>
{
...
#if defined(CGOGN_USE_EXTERNAL_TEMPLATES) && (!defined(CGOGN_IO_CSKELL_IO_CPP_))
...
#endif // defined(CGOGN_USE_EXTERNAL_TEMPLATES) && (!defined(CGOGN_IO_CSKELL_IO_CPP_))

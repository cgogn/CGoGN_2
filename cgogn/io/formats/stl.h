...
class StlSurfaceImport : public SurfaceFileImport<MAP>
{
public:
...
extern template class CGOGN_IO_EXPORT StlSurfaceImport<CMap2, Eigen::Vector3d>;
extern template class CGOGN_IO_EXPORT StlSurfaceImport<CMap2, Eigen::Vector3f>;
extern template class CGOGN_IO_EXPORT StlSurfaceImport<CMap2, geometry::Vec_T<std::array<float64, 3>>>;
extern template class CGOGN_IO_EXPORT StlSurfaceImport<CMap2, geometry::Vec_T<std::array<float32, 3>>>;
extern template class CGOGN_IO_EXPORT StlSurfaceExport<CMap2>;

...
#ifndef CGOGN_IO_FORMATS_TETMESH_H_
#define CGOGN_IO_FORMATS_TETMESH_H_
...
extern template class CGOGN_IO_EXPORT TetMeshVolumeImport<CMap3, Eigen::Vector3d>;
extern template class CGOGN_IO_EXPORT TetMeshVolumeImport<CMap3, Eigen::Vector3f>;
extern template class CGOGN_IO_EXPORT TetMeshVolumeImport<CMap3, geometry::Vec_T<std::array<float64, 3>>>;
extern template class CGOGN_IO_EXPORT TetMeshVolumeImport<CMap3, geometry::Vec_T<std::array<float32, 3>>>;

extern template class CGOGN_IO_EXPORT TetMeshVolumeExport<CMap3>;
...
#endif // CGOGN_IO_FORMATS_TETMESH_H_

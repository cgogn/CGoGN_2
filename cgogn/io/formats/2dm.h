...
#ifndef CGOGN_IO_FORMATS_2DM_H_
#define CGOGN_IO_FORMATS_2DM_H_
...
extern template class CGOGN_IO_EXPORT SMS2DMSurfaceImport<CMap2, Eigen::Vector3d>;
extern template class CGOGN_IO_EXPORT SMS2DMSurfaceImport<CMap2, Eigen::Vector3f>;
extern template class CGOGN_IO_EXPORT SMS2DMSurfaceImport<CMap2, geometry::Vec_T<std::array<float64, 3>>>;
extern template class CGOGN_IO_EXPORT SMS2DMSurfaceImport<CMap2, geometry::Vec_T<std::array<float32, 3>>>;

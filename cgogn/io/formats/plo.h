...
extern template class CGOGN_IO_EXPORT PloPointSetImport<CMap0, Eigen::Vector3d>;
extern template class CGOGN_IO_EXPORT PloPointSetImport<CMap0, Eigen::Vector3f>;

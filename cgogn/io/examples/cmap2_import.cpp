...
int main(int argc, char** argv)
{
	...
	for (uint32 k = 0; k < 2; ++k)
	{
		...
		VertexAttribute<Vec3> vertex_position = map.attribute<Vec3, Map2::Vertex::ORBIT>("position");
		VertexAttribute<Vec3> vertex_normal = map.attribute<Vec3, Map2::Vertex::ORBIT>("normal");
		FaceAttribute<Vec3> face_normal = map.attribute<Vec3, Map2::Face::ORBIT>("normal");

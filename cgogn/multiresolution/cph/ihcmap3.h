...
class IHCMap3_T : public CMap3_T<DATA_TRAITS, MAP_TYPE>, public CPH3<DATA_TRAITS>
{
public:

    typedef CMap3_T<DATA_TRAITS, MAP_TYPE> Inherit_CMAP;
    typedef CPH3<DATA_TRAITS> Inherit_CPH;
    typedef IHCMap3_T<DATA_TRAITS, MAP_TYPE> Self;
